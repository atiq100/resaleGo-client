...
const Footer = () => {
    return (
        <footer className="px-4 mt-2 divide-y dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<Link rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">ResaleGo</span>
			</Link>
		</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2022 AM Co. All rights reserved.</div>
</footer>
    );
};
